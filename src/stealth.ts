...
export function humanDelay(baseMs: number, variance: number = 0.3): Promise<void> {
 ...
 */
export async function humanWaitForLoad(page: Page): Promise<void> {
 ...
 */
export function nextPollInterval(baseMs: number): number {
